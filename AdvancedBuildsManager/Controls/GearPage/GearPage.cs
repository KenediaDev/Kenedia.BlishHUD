    ...
    public class GearPage : Blish_HUD.Controls.Container
    {
        ...
        public GearPage()
        {
            ...
            _slots = new()
            {
                ...
                {GearTemplateSlot.Back, new JewellerySlotControl(GearTemplateSlot.Back, this) { Width = 85 } },
                {GearTemplateSlot.Amulet, new AmuletSlotControl(GearTemplateSlot.Amulet, this){ Width = 85 }},
                {GearTemplateSlot.Accessory_1, new JewellerySlotControl(GearTemplateSlot.Accessory_1, this){ Width = 85 }},
                {GearTemplateSlot.Accessory_2, new JewellerySlotControl(GearTemplateSlot.Accessory_2, this){ Width = 85}},
                {GearTemplateSlot.Ring_1, new JewellerySlotControl(GearTemplateSlot.Ring_1, this){ Width = 85 }},
                {GearTemplateSlot.Ring_2, new JewellerySlotControl(GearTemplateSlot.Ring_2, this){ Width = 85 }},
