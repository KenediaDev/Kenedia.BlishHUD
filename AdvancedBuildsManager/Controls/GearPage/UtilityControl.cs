...
{
    public class OLDUtilityControl : Blish_HUD.Controls.Control
    {
        ...
        public OLDUtilityControl()
        {
            _utility.Texture = AdvancedBuildsManager.ModuleInstance.ContentsManager.GetTexture(@"textures\utilityslot.png");
            Size = new(45, 45);
        }
