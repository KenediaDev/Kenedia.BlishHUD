...
namespace Kenedia.Modules.AdvancedBuildsManager.Controls.BuildPage.ProfessionSpecific
{
    ...
    public class RevenantSpecifics : ProfessionSpecifics
    {
        ...
        protected override void ApplyTemplate()
        {
            ...
            {
                _professionSkill2.Skill = AdvancedBuildsManager.Data.Professions[Gw2Sharp.Models.ProfessionType.Revenant].Skills[55029];
            }
        ...
        private void GetSelectableLegends(LegendSlot legendSlot)
        {
            ...
            var legends = AdvancedBuildsManager.Data.Professions[Gw2Sharp.Models.ProfessionType.Revenant].Legends.Where(e => e.Value.Specialization == 0 || e.Value.Specialization == Template.EliteSpecialization?.Id);
