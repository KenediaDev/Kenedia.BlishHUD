...
namespace Kenedia.Modules.AdvancedBuildsManager.Controls.Selection
{
        ...
        private void SetValue(object sender, PropertyChangedEventArgs e)
        {
            ...
            switch (SelectionType)
            {
                case ProfessionRaceSelection.SelectionType.Profession:
                    if (AdvancedBuildsManager.Data.Professions.TryGetValue((ProfessionType)Value, out var profession))
                    {
                ...
                case ProfessionRaceSelection.SelectionType.Race:
                    if (AdvancedBuildsManager.Data.Races.TryGetValue((Races)Value, out var race))
                    {
    ...
    public class BuildSelection : BaseSelection
    {
        ...
        public BuildSelection()
        {
            ...
            foreach (var prof in AdvancedBuildsManager.Data.Professions.Values)
            {
                int j = 0;
                _specIcons.Add(new()
                {
            ...
            _addBuildsButton = new()
            {
                ...
                ClickAction = (m) =>
                {
                    _ = Task.Run(async () =>
                    {
                        ...
                        {
                            AdvancedBuildsManager.ModuleInstance.Templates.Add(t = new() { Name = name });
            ...
            AdvancedBuildsManager.ModuleInstance.SelectedTemplateChanged += ModuleInstance_SelectedTemplateChanged;
            ...
            AdvancedBuildsManager.ModuleInstance.Templates.CollectionChanged += Templates_CollectionChanged;
        ...
        private void Templates_CollectionChanged(object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
            ...
            var removedTemplates = templates.Except(AdvancedBuildsManager.ModuleInstance.Templates);
            var addedTemplates = AdvancedBuildsManager.ModuleInstance.Templates.Except(templates);
            bool firstLoad = _templates.Count == 0 && AdvancedBuildsManager.ModuleInstance.Templates.Count != 0;
